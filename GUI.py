...
def login_in():
	...
	orionLabel=Label(login_menu, text="SCHOOL MANAGEMENT",bg='dark orange',font=("Castellar", "25","bold","italic","underline"),fg="black")
	subLabel=Label(login_menu, text="A MANAGEMENT SYSTEM",font=("Castellar", "16","bold","italic"))
...
def Main_Menu():
	...
	orionLabel=Label(base, text="SCHOOL MANAGEMENT",bg='dark orange',font=("Castellar", "50","bold","italic","underline"),fg="black")
